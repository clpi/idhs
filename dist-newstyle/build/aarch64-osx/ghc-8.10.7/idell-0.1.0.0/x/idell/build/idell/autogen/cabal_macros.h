...
/* package idell-0.1.0.0 */
#ifndef VERSION_idell
#define VERSION_idell "0.1.0.0"
#endif /* VERSION_idell */
#ifndef MIN_VERSION_idell
#define MIN_VERSION_idell(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_idell */
...
#define CURRENT_COMPONENT_ID "idell-0.1.0.0-inplace-idell"
